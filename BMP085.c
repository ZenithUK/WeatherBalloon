/*
Modified by Ben Bancroft 22 June 2013.
All modifications to this file are also licenced under Creative Commons 3.0 - http://creativecommons.org/licenses/by-sa/3.0/
Original is located here - http://www.john.geek.nz/2013/02/update-bosch-bmp085-source-raspberry-pi/
...
//made extern - renamed temperature!
...
//Changed to externally called function
int readBMP085()
{
	internalTemp = (float)(bmp085_GetTemperature(bmp085_ReadUT())) / 10;
